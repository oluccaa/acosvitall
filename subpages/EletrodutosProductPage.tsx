...
const EletrodutosProductPage: React.FC = () => {
    ...
    const slides = [...ASSETS.PRODUCT_PAGES.ELETRODUTOS.SLIDES];
    ...
    const models = [
        { name: "PRÉ-ZINCADO LEVE", desc: "Rígidos de aço com acabamento galvanizado eletrolítico para ambientes internos.", image: ASSETS.PRODUCT_PAGES.ELETRODUTOS.MODELS.LEVE },
        { name: "PESADO NBR 13057", desc: "Eletrodutos conforme norma NBR 13057 com luva e protetor de rosca.", image: ASSETS.PRODUCT_PAGES.ELETRODUTOS.MODELS.PESADO },
        { name: "GALVANIZADO À FOGO", desc: "Rígidos de aço com acabamento por imersão a quente para ambientes externos.", image: ASSETS.PRODUCT_PAGES.ELETRODUTOS.MODELS.FOGO_PESADO },
        { name: "ATMOSFERA EXPLOSIVA", desc: "RIR NPT conforme NBR 5597 para áreas classificadas e alta criticidade.", image: ASSETS.PRODUCT_PAGES.ELETRODUTOS.MODELS.RIR_NPT },
    ];
        ...
        <div className="bg-white">
            <section className="relative h-[40vh] min-h-[350px] overflow-hidden bg-gray-900 flex items-center justify-center">
                ...
                <div className="relative z-20 text-center animate-in fade-in zoom-in duration-700">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-white uppercase tracking-widest">ELETRODUTOS</h1>
                </div>
            </section>
