...
const TelhasTrapezoidaisProductPage: React.FC = () => {
    ...
    const slides = [...ASSETS.PRODUCT_PAGES.TELHAS.SLIDES];
    ...
    const models = [
        { name: "GALVALUME", desc: "Resistência e economia para coberturas industriais e rurais.", image: ASSETS.PRODUCT_PAGES.TELHAS.MODELS.GALVALUME },
        { name: "PINTADA", desc: "Estética e proteção extra contra corrosão com cores variadas.", image: ASSETS.PRODUCT_PAGES.TELHAS.MODELS.PINTADA },
        { name: "TERMOSTÁTICA", desc: "Conforto térmico e eficiência energética para grandes galpões.", image: ASSETS.PRODUCT_PAGES.TELHAS.MODELS.TERMOSTATICA },
    ];
        ...
        <div className="bg-white">
            <section className="relative h-[40vh] min-h-[350px] overflow-hidden bg-gray-900 flex items-center justify-center">
                ...
                <div className="relative z-20 text-center animate-in fade-in zoom-in duration-700">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-white uppercase tracking-widest drop-shadow-2xl">TELHAS</h1>
                </div>
            </section>
