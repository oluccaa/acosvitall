...
const ValvulasProductPage: React.FC = () => {
    ...
    const slides = [...ASSETS.PRODUCT_PAGES.VALVULAS.SLIDES];
    ...
    const models = [
        { name: "BORBOLETA", desc: "Design compacto para sistemas de grande diâmetro e baixa pressão.", image: ASSETS.PRODUCT_PAGES.VALVULAS.MODELS.BORBOLETA },
        { name: "ESFERA", desc: "Abertura rápida e vedação precisa para fluídos corrosivos.", image: ASSETS.PRODUCT_PAGES.VALVULAS.MODELS.ESFERA },
        { name: "GAVETA", desc: "Robustez para operações que exigem abertura total do fluxo.", image: ASSETS.PRODUCT_PAGES.VALVULAS.MODELS.GAVETA },
        { name: "GLOBO", desc: "Controle preciso do fluxo para setores que demandam regulação minuciosa.", image: ASSETS.PRODUCT_PAGES.VALVULAS.MODELS.GLOBO },
    ];
        ...
        <div className="bg-white">
            <section className="relative h-[40vh] min-h-[350px] overflow-hidden bg-gray-900 flex items-center justify-center">
                ...
                <div className="relative z-20 text-center animate-in fade-in zoom-in duration-700">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-white uppercase tracking-widest">VÁLVULAS</h1>
                </div>
            </section>
            ...
            <section className="py-24 bg-white border-t border-gray-100">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <a href="/tables" className="inline-flex items-center bg-brand-orange text-white font-bold py-4 px-10 rounded-full hover:bg-brand-orange-dark transition-all duration-300 shadow-lg transform hover:-translate-y-1 group">
                        <span className="uppercase tracking-wide text-sm">Ver Tabelas Técnicas</span>
