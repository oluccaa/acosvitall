...
import { CheckCircle, ChevronRight, FileText, Settings, Zap, Flame } from 'lucide-react';

const OxicorteProductPage: React.FC = () => {
    const [currentSlide, setCurrentSlide] = useState(0);
    const slides = [...ASSETS.PRODUCT_PAGES.OXICORTE.SLIDES];
    ...
    const models = [
        { name: "MAÇARICO", desc: "Versatilidade e eficiência para cortes manuais em aço carbono.", image: ASSETS.PRODUCT_PAGES.OXICORTE.MODELS.MACARICO },
        { name: "TARTARUGA", desc: "Cortes automáticos retos em grandes chapas com uniformidade.", image: ASSETS.PRODUCT_PAGES.OXICORTE.MODELS.TARTARUGA },
        { name: "CNC PLASMA", desc: "Alta velocidade e precisão computacional em cortes complexos.", image: ASSETS.PRODUCT_PAGES.OXICORTE.MODELS.PLASMA },
        { name: "FOTOCÉLULA", desc: "Reprodução exata de modelos a partir de desenhos técnicos.", image: ASSETS.PRODUCT_PAGES.OXICORTE.MODELS.FOTOCELULA },
    ];
        ...
        <div className="bg-white">
            <section className="relative h-[40vh] min-h-[350px] overflow-hidden bg-gray-900 flex items-center justify-center">
                ...
                <div className="relative z-20 text-center animate-in fade-in zoom-in duration-700">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-white uppercase tracking-widest text-shadow-xl">OXICORTE</h1>
                </div>
            </section>
            ...
            <section className="py-24 bg-white border-t border-gray-100">
                <div className="container mx-auto px-6 text-center">
                    <h2 className="text-3xl font-bold text-brand-blue-dark mb-12">TECNOLOGIA E PRECISÃO</h2>
