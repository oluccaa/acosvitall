...
const CivilProductPage: React.FC = () => {
    ...
    const slides = [...ASSETS.PRODUCT_PAGES.CIVIL.SLIDES];
    ...
    const models = [
        { name: "ARAME RECOZIDO", desc: "Flexibilidade e alta resistência para amarrações em estruturas de concreto.", image: ASSETS.PRODUCT_PAGES.CIVIL.MODELS.ARAME },
        { name: "BARRA DE TRANSFERÊNCIA", desc: "Distribuição eficiente de cargas em pisos industriais.", image: ASSETS.PRODUCT_PAGES.CIVIL.MODELS.BARRA_TRANSF },
        { name: "VERGALHÕES", desc: "Aço CA-25, CA-50 e CA-60 para armações robustas.", image: ASSETS.PRODUCT_PAGES.CIVIL.MODELS.VERGALHOES },
        { name: "TELA SOLDADA", desc: "Alta aderência entre aço e concreto para fundações e lajes.", image: ASSETS.PRODUCT_PAGES.CIVIL.MODELS.TELA },
        { name: "TRELIÇA", desc: "Suporte estrutural otimizado para lajes treliçadas.", image: ASSETS.PRODUCT_PAGES.CIVIL.MODELS.TRELICA },
    ];
        ...
        <div className="bg-white">
            <section className="relative h-[40vh] min-h-[350px] overflow-hidden bg-gray-900 flex items-center justify-center">
                ...
                <div className="relative z-20 text-center animate-in fade-in zoom-in duration-700">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-white uppercase tracking-widest">CIVIL</h1>
                </div>
            </section>
            ...
            <section className="py-24 bg-white border-t border-gray-100">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <a href="/tables" className="inline-flex items-center bg-brand-orange text-white font-bold py-4 px-10 rounded-full hover:bg-brand-orange-dark transition-all duration-300 shadow-lg transform hover:-translate-y-1 group">
                        <span className="uppercase tracking-wide text-sm">Ver Tabelas de Aço Civil</span>
