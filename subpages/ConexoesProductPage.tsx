...
import { CheckCircle, ChevronRight, FileText, Settings, Layers } from 'lucide-react';

const ConexoesProductPage: React.FC = () => {
    const [currentSlide, setCurrentSlide] = useState(0);
    const slides = [...ASSETS.PRODUCT_PAGES.CONEXOES.SLIDES];
    ...
    const models = [
        { name: "ALTA PRESSÃO", desc: "Conexões forjadas operando em condições extremas sem vazamentos.", image: ASSETS.PRODUCT_PAGES.CONEXOES.MODELS.ALTA_PRESSAO },
        { name: "GOMADAS", desc: "Robustez para sistemas que necessitam flexibilidade com estanqueidade.", image: ASSETS.PRODUCT_PAGES.CONEXOES.MODELS.GOMADAS },
        { name: "TUBULARES", desc: "Componentes para unir seções de tubos com alta resistência mecânica.", image: ASSETS.PRODUCT_PAGES.CONEXOES.MODELS.TUBULARES },
    ];
        ...
        <div className="bg-white">
            <section className="relative h-[40vh] min-h-[350px] overflow-hidden bg-gray-900 flex items-center justify-center">
                ...
                <div className="relative z-20 text-center animate-in fade-in zoom-in duration-700">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-white uppercase tracking-widest">CONEXÕES</h1>
                </div>
            </section>
