...
const TanqueCombustivelProductPage: React.FC = () => {
    ...
    const slides = [...ASSETS.PRODUCT_PAGES.TANQUES.SLIDES];
    ...
    const productModels = [
        { name: "TANQUE AÉREO", desc: "Armazenamento acima do solo conforme NBR 15461.", image: ASSETS.PRODUCT_PAGES.TANQUES.MODELS.AEREO },
        { name: "TANQUE JAQUETADO", desc: "Sistema de parede dupla para monitoramento ambiental.", image: ASSETS.PRODUCT_PAGES.TANQUES.MODELS.JAQUETADO },
        { name: "TANQUE GLP", desc: "Vasos de pressão para armazenamento seguro de gás.", image: ASSETS.PRODUCT_PAGES.TANQUES.MODELS.GLP },
        { name: "SKIDS", desc: "Módulos completos integrados para abastecimento de frotas.", image: ASSETS.PRODUCT_PAGES.TANQUES.MODELS.MODULOS },
    ];
        ...
        <div className="bg-white">
            <section className="relative h-[40vh] min-h-[350px] overflow-hidden bg-gray-900 flex items-center justify-center">
                ...
                <div className="relative z-20 text-center animate-in fade-in zoom-in duration-700">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-white uppercase tracking-widest">TANQUES</h1>
                </div>
            </section>
