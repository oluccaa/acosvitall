...
export const pt = {
    ...
    infoColumns: {
        ...
        tabs: {
            ...
            recognition: { title: "Reconhecimento", description: "Líderes no fornecimento de soluções em aço no Brasil e América Latina." }
        }
    },
    contactPage: {
        hero: { title: "Fale Conosco", subtitle: "Nossa equipe técnica está pronta para atendê-lo." },
        options: { title: "Nossas Unidades", cards: { address: { title: "Matriz" }, phone: { title: "Contatos" } } },
        form: {
            title: "Enviar Mensagem",
            subtitle: "Preencha o formulário para um orçamento rápido.",
            name: "Nome Completo",
            company: "Empresa",
            email: "E-mail Corporativo",
            phone: "Telefone / WhatsApp",
            interest: "Assunto",
            interests: ["Orçamento", "Dúvida Técnica", "Financeiro", "Outros"],
            message: "Mensagem",
            sendButton: "Enviar",
            successTitle: "Mensagem Enviada!",
            successMsg: "Em breve entraremos em contato.",
            sendAnother: "Nova Mensagem",
            whatsappButton: "Chamar no WhatsApp"
        }
    },
    catalogPage: {
        links: {
            products: { title: "Linha de Produtos", buttonText: "Ver Agora" },
            tables: { title: "Tabelas Técnicas", buttonText: "Ver Agora" }
        }
    },
    certificationsPage: {
