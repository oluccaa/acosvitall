...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="bg-brand-blue-dark text-slate-300 pt-16 pb-8 border-t-[3px] border-brand-orange font-sans">
            <div className="container mx-auto px-6 sm:px-12 lg:px-24 max-w-7xl">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="pt-2">
                            ...
                            <div className="flex gap-3">
                                <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-orange hover:text-white transition-all duration-300 group border border-white/10">
                                ...
                                <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-orange hover:text-white transition-all duration-300 group border border-white/10">
                                    <Youtube size={18} className="text-slate-300 group-hover:text-white" />
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2 lg:pl-12">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3">
                            <ul className="space-y-3">
                                {leftLinks.map(link => (
                                    <li key={link.key}>
                                        <a href={link.href} className="flex items-center gap-2 hover:text-brand-orange text-white transition-colors text-sm font-bold uppercase group">
                                            <ChevronRight size={14} className="text-brand-orange group-hover:text-white transition-colors" />
                                            {link.label}
                                        </a>
                                    </li>
                                ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-6">
                            <li className="flex items-start gap-4 group">
                                ...
                                <address className="not-italic text-sm text-slate-300 leading-relaxed group-hover:text-white transition-colors">
                            ...
                            <li className="flex items-center gap-4 group">
                                ...
                                <a href="tel:1147972352" className="text-sm text-white font-bold group-hover:text-brand-orange transition-colors">
                                    (11) 4797-2352
                                </a>
                            </li>
                            <li className="flex items-center gap-4 group">
                                <Mail size={20} className="text-brand-orange" />
                                <a href="mailto:acosvital@acosvital.com.br" className="text-sm text-white font-bold group-hover:text-brand-orange transition-colors">
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-400 font-medium">
                    <p>&copy; {new Date().getFullYear() + 1} Aços Vital Indústria e Comércio. Todos os direitos reservados.</p>
                    <p className="text-slate-300 font-bold">Desenvolvido com excelência</p>
                </div>
            </div>
        </footer>
    );
