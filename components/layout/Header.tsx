...
const Header: React.FC = () => {
    ...
    return (
        <>
            <header role="banner" className="relative z-50 bg-brand-blue-dark border-b border-white/5 w-full">
                {/* Top Bar */}
                <div className="w-full bg-brand-blue-dark border-b border-white/5 py-2.5">
                     <div className="container mx-auto px-6 sm:px-12 lg:px-24 max-w-7xl flex justify-between items-center text-[11px] font-medium tracking-wide text-gray-400">
                         <div className="flex items-center gap-4">
                            ...
                            <span className="hidden sm:inline w-px h-3 bg-white/10" aria-hidden="true"></span>
                         ...
                         <div className="flex items-center gap-4">
                            <a 
                                ...
                                aria-label={`${t('header.navLinks.qualityPortal')} - Abre em nova aba`}
                            >
                                <ShieldCheck size={12} className="text-brand-orange" aria-hidden="true" />
                                <span>{t('header.navLinks.qualityPortal')}</span>
                            </a>
                            <span className="w-px h-3 bg-white/10" aria-hidden="true"></span>
                            <nav aria-label="Redes sociais" className="hidden sm:block">
                                <ul className="flex items-center space-x-3">
                                    {SOCIAL_LINKS.map((link) => {
                                        ...
                                        return (
                                            <li key={link.key}>
                                                <a href={link.href} aria-label={`Siga-nos no ${link.key}`} className="hover:text-white transition-colors block">
                ...
                <div className="w-full py-5">
                    <div className="container mx-auto px-6 sm:px-12 lg:px-24 max-w-7xl relative">
                        <div className="flex justify-between items-center gap-6">
                            ...
                            <a href="#/" aria-label="Aços Vital - Página Inicial" className="flex-shrink-0 z-50 transition-transform duration-300 hover:scale-105 origin-left">
                            ...
                            <div className="flex items-center gap-3 z-50 flex-shrink-0">
                                <button 
                                    ...
                                    className="hidden lg:flex items-center justify-center w-10 h-10 text-white hover:text-brand-orange transition-colors rounded-full hover:bg-white/5 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange"
                                    aria-label="Pesquisar (Atalho: Ctrl+K)"
                                ...
                                <div className="lg:hidden">
                                    ...
                                    >
                                        <div className="relative w-6 h-5 flex flex-col justify-between items-end" aria-hidden="true">
            ...
            <div 
                ...
                `}
            >
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-orange/5 rounded-full blur-[120px] pointer-events-none -translate-y-1/2 translate-x-1/2" aria-hidden="true"></div>
                ...
                <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-hide px-6 py-6 relative z-10">
                    <button 
                        className="w-full flex items-center bg-white/5 border border-white/10 rounded-xl px-4 py-3.5 mb-8 text-gray-200 active:bg-white/10 transition-colors text-left hover:border-brand-orange/30"
                        onClick={() => { closeMobileMenu(); setIsSearchOpen(true); }}
                        aria-label="Abrir busca global"
                    >
                        <Search size={20} className="mr-3 text-brand-orange" aria-hidden="true" />
                        <span className="text-sm font-medium opacity-80">{t('layout.searchPlaceholder')}</span>
                    </button>

                    <nav className="flex flex-col gap-1">
                        <a href="#/" onClick={closeMobileMenu} className={`flex items-center gap-4 p-4 rounded-xl transition-all ${isLinkActive('#/') ? 'bg-white/10 text-white' : 'text-gray-200 hover:bg-white/5'}`}>
                            <Home size={20} className={isLinkActive('#/') ? 'text-brand-orange' : 'text-gray-400'} aria-hidden="true" />
                            <span className="font-bold text-lg">{t('header.navLinks.home')}</span>
                        </a>

                        <a href="#/about" onClick={closeMobileMenu} className={`flex items-center gap-4 p-4 rounded-xl transition-all ${isLinkActive('#/about') ? 'bg-white/10 text-white' : 'text-gray-200 hover:bg-white/5'}`}>
                            <Award size={20} className={isLinkActive('#/about') ? 'text-brand-orange' : 'text-gray-400'} aria-hidden="true" />
                        ...
                        <div className="border-y border-white/5 my-2 py-2">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <Package size={20} className="text-brand-orange" aria-hidden="true" />
                                    <span className="font-bold text-lg">{t('header.navLinks.products')}</span>
                                </div>
                                <ChevronRight size={20} className={`transition-transform duration-300 ${isProductsExpanded ? 'rotate-90 text-brand-orange' : 'text-gray-500'}`} aria-hidden="true" />
                            </button>

                            <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isProductsExpanded ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'}`} id="products-expand-area">
                                <div className="pl-4 pr-2 pb-4 space-y-3">
                                            ...
                                            <div key={group.id} className="bg-white/5 rounded-lg overflow-hidden border border-white/5">
                                                ...
                                                >
                                                    <div className="flex items-start gap-3">
                                                        <div className={`mt-0.5 ${isActiveGroup ? 'text-brand-orange' : 'text-gray-400'}`} aria-hidden="true">
                                                            {group.icon}
                                                        </div>
                                                        <div>
                                                    ...
                                                    <ChevronRight size={16} className={`transition-transform ${isActiveGroup ? 'rotate-90 text-brand-orange' : 'text-gray-500'}`} aria-hidden="true" />
                                                </button>
                                                    ...
                                                    <div className="bg-black/20 p-2 grid grid-cols-1 gap-1 animate-slide-in">
                                                        {groupProducts.map(prod => (
                                                            ...
                                                            >
                                                                ...
                                                                <ArrowRight size={14} className="opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all text-brand-orange" aria-hidden="true" />
                                                            </a>
                                                        ))}
                                                    </div>
                                                )}
                                    ...
                                    >
                                        <FileText size={16} aria-hidden="true" /> {t('header.mobileLinks.downloadCatalog')}
                                    </a>
                                </div>
                            </div>
                        </div>

                        <a href="#/calculator" onClick={closeMobileMenu} className={`flex items-center gap-4 p-4 rounded-xl transition-all ${isLinkActive('#/calculator') ? 'bg-white/10 text-white' : 'text-gray-200 hover:bg-white/5'}`}>
                            <Calculator size={20} className={isLinkActive('#/calculator') ? 'text-brand-orange' : 'text-gray-400'} aria-hidden="true" />
                        ...
                        <a href="#/tables" onClick={closeMobileMenu} className={`flex items-center gap-4 p-4 rounded-xl transition-all ${isLinkActive('#/tables') ? 'bg-white/10 text-white' : 'text-gray-200 hover:bg-white/5'}`}>
                            <FileText size={20} className={isLinkActive('#/tables') ? 'text-brand-orange' : 'text-gray-400'} aria-hidden="true" />
                            <div className="flex flex-col">
                         ...
                         <a href="#/contact" onClick={closeMobileMenu} className={`flex items-center gap-4 p-4 rounded-xl transition-all ${isLinkActive('#/contact') ? 'bg-white/10 text-white' : 'text-gray-200 hover:bg-white/5'}`}>
                            <Mail size={20} className={isLinkActive('#/contact') ? 'text-brand-orange' : 'text-gray-400'} aria-hidden="true" />
                        ...
                        <a 
                            ...
                            aria-label="Portal da Qualidade - Abre em nova aba"
                        >
